package com.codingapi.sdk.okx.websocket.dto;
...
public class Position {
    ...
    private final List<OrderAlgo> orderAlgos;

    public Position(int lever, float posUsdt, float upl, float uplRatio,
                    float avgPx, float margin, float mgnRatio,
                    float liqPx, float markPx,
                    List<OrderAlgo> orderAlgos) {
        this.lever = lever;
    ...
    public void print(){
        ...
        for(OrderAlgo orderAlgo:orderAlgos){
            System.out.println(orderAlgo);
        }
    }
}
